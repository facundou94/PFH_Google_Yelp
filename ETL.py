...
get_ipython().run_line_magic('run', 'genera_fechas.py')
...
# 2 - Script para carga incremental MySQL:

# In[61]:


#%run cargar_incremental_sql.py


# ## 3 - Cargamos la Información a:
# 
...
get_ipython().run_line_magic('run', 'genera_entradas.py')
